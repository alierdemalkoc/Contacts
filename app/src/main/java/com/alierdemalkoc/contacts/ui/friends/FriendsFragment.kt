package com.alierdemalkoc.contacts.ui.friends
...
import com.alierdemalkoc.contacts.databinding.FragmentFriendsBinding
...
class FriendsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listView.setOnItemClickListener { adapterView, view, i, l ->
            ...
            findNavController().navigate(R.id.friendsToDetail, bundle)
        }
    }
